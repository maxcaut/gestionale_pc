                <!-- ================= TAB: SQUADRE A.I.B. ================= -->
                <section id="tab-squadre-aib" data-squadre-aib-access class="tab-content space-y-6 hidden fade-in">
                    <div class="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
                        <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                            <div class="relative w-full sm:w-64">
                                ...
                                <input type="text" id="search-squadre-aib" oninput="renderSquadreAib()" placeholder="Cerca squadra..." class="w-full bg-slate-900 border border-slate-800 text-slate-100 pl-10 pr-4 py-2.5 rounded-xl text-sm focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-colors">
                            </div>

                            <select id="filter-stato-squadre-aib" onchange="renderSquadreAib()" class="bg-slate-900 border border-slate-800 text-slate-300 py-2.5 px-4 rounded-xl text-sm focus:outline-none focus:border-amber-500 transition-colors">
                    ...
                    <div class="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-xl">
                        <div class="overflow-x-auto">
                            <table class="w-full text-left border-collapse">
                                ...
                                <tbody id="squadre-aib-table-body" class="text-sm divide-y divide-slate-800/40">
