...
class ServizioPdfController extends Controller
{
    public function export(Request $request)
    {
        $validated = $request->validate([
            ...
            'mezzo' => 'nullable|array',
            'mezzo.modello' => 'nullable|string',
            'mezzo.targa' => 'nullable|string',
            'mezzo.tipo' => 'nullable|string',
            'mezzo.stato' => 'nullable|string',
